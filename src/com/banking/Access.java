...
public class Access {
	static Connection connect= Connection_banking.getConnection();
	static String sql=" ";
	static int ac=100;
...
public boolean createAccount(Transfer transfer) throws Exception
{
	...
	try
	{
		...
		ac+=1;
		sql="insert into bankking1(acc_no,user_name,balance,pin) values("+ac+",'"+u_name+"' ,500, "+pin+")";
		Connection connect1=Connection_banking.getConnection();
...
public void withdrawAmount(int accountNumber) throws Exception
{
    try
    {
       ...
       System.out.println("Your account number and balance ....");
       Access access=new Access();
